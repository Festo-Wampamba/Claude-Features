...
description: Grounds and drafts coursework for UoPeople's CS 1105 (Digital Electronics & Computer Architecture) - Learning Journal assignments, Discussion Forum posts, and peer replies - in the actual course materials on disk, then writes the answer in natural first-person student prose instead of AI-sounding text. Use this whenever the user is working on ANY CS 1105 / "Digital EC & ARCH" deliverable: mentions Unit 1-9, Logisim, TECS, Boolean algebra, logic gates, combinational or sequential circuits, ALU, computer arithmetic, memory, CPU design, assembler, or pastes in a Brightspace unit page, discussion prompt, or rubric for this course. Also use it any time the user asks to "make this sound human," "avoid AI writing," or "fix this so it doesn't get flagged" on a piece of their own academic writing for this course.
---
